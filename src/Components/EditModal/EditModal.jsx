                        ...
                        <div className="relative bg-white rounded-lg shadow ">
                            ...
                            <div className="p-4 md:p-5">
                                <div className="space-y-5" action="#">
                                    ...
                                    <button onClick={onSubmit} type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">ثبت اطلاعات جدید</button>
                                </div>
                            </div>
                        </div>
                    </div>
